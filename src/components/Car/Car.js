...
function Car (props) {
    ...
    //const {Marca,Modelo,Aceleracion,VelocidadMaxima} = props;
    var coche = {
        marca: props.Marca
        , modelo: props.Modelo
    ...
    //CREAMOS UN METODO QUE DEVOLVERA HTML CON ESTILO DEPENDIENDO 
    //DEL ESTADO DE LA VARIABLE estado
    ...
    //ESTA VARIABLE PARA SABER SI EL COCHE ESTA ARRANCADO O NO
